...
public class Prjava43martin19 extends Frame 
   ...
   public Prjava43martin19 () { 
      ...
      setTitle("prjava43martin19");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43martin19();  // Let the construct do the job 
   } 
